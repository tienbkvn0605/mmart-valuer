...
if($p_kind == 'zaikou_settei'){

	if(isset($_POST['ai_serial'])){
		$ai_serial = $_POST['ai_serial'];
		$data = [
			'm_zaiko_disp_flg' => 1,
			'm_zaiko' => $_POST['in_zaiko']
		];
		$res = $c_item -> update_zaikou($ai_serial,$data);
...
//html
include_once('/var/www/html3/outlet/valeur/seller/tpl/tpl_list_item_2.php');
?>
