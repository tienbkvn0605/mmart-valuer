...
食塩相当量　　○g
                        ...
                        <div class="kakunin" style="padding-top: 20px" > 
                            <div class="text_center padding_20px" >
                                ...
                                <?php if(!$item_draft):?>
                                    <input class="btn btn-success ms-5" type="button" name="b_type" value="　　下書き　　" onClick="F_check_item(this.form,'item_draft')">
                                <?php endif?>
                            </div>
                        </div>
                        ...
                        <?php endif; ?>
                        <input type="hidden" name="p_type" id="p_type" value="<?php echo ($item_draft ? 'draft' : ''); ?>">
                        <input type="hidden" name="ai_serial" value="<?php echo (isset($item_data['ai_serial']) ? $item_data['ai_serial'] : '');?>" id="ai_serial">
                    </form>
                </div>
            </div>
        </section>
