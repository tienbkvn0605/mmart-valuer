    ...
    <body>
        ...
        <nav class="mb-5">
            <div class="nav nav-tabs " id="nav-tab" role="tablist">
                ...
                <button class="nav-link  ps-4 pe-4" id="tab_draft" data-bs-toggle="tab" data-bs-target="#nav_tab_draft" type="button" role="tab" aria-controls="nav_tab_draft" aria-selected="false">
                    下書き
                </button>
            </div>
        </nav>
                ...
                <?php foreach ($A_items as $key => $items) { 
                    ...
                    <div class="tab-pane fade <?php echo $show;?>" id="<?php echo $f_tab_id;?>" role="tabpanel" aria-labelledby="#<?php echo $f_button_tab;?>">
                        <form method="post" id="f_base_<?php echo $key; ?>" name="f_base_<?php echo $key; ?>" action="<?php echo $_SERVER['PHP_SELF']; ?>" target="_self">
                            <table class="table table-hover table-bordered top" id="shinsei_tbl_<?php echo $key;?>">
                                    ...
                                    <?php if(!empty($items)):?>
                                        <?php foreach ($items as $key_item => $item) { 
                                            ...
                                            <tr <?php echo $f_kyakka_mes;?> >
                                                ...
                                                <!-- 編集ボタン -->
                                                <td valign="middle" class="text-center">
                                                    <?php if($item['draft_flg'] == 1 && $item['review_flg'] == 0): ?>
                                                        <a href="/outlet/valeur/seller/itemreg.php?p_kind=item_edit&p_type=draft&ai_serial=<?php echo $item['ai_serial'];?>" class="btn btn-outline-primary pt-0 pb-0 mb-1">編集</a>
                                                    <?php else: ?>
