...
<head>
	...
	body {
		background-image: linear-gradient(to bottom,rgb(255 255 0 / 5%),rgb(0 0 255 / 5%)),url(https://images.unsplash.com/photo-1598063183638-4ffe7c5f0f8d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
...
<table class="table table-sm table-border border border-secondary box-shadow">
<tbody>
    <tr>
...
<section class="bg-border box-shadow">
	...
	<center>
	<br>
<div class="box-shadow" style="width:650px;text-align:left;border:1px solid #888;padding:10px;font-size:16px;background-color: #e9f5ff;">
