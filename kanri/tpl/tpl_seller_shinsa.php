...
<table class="table table-hover table-bordered top" id="shinsei_tbl">
    ...
    <tbody>
    <?php if(isset($A_seller_shinsa["arr_koukai"]) && is_array($A_seller_shinsa["arr_koukai"]) ): $cnt = 0; foreach($A_seller_shinsa["arr_koukai"] as $k => $v): $cnt++; ?>
    <tr>
        <!-- NO -->
        <td class="text-center"><?php echo($cnt); ?></td>
        <!-- 店舗名 -->
...
<?php if(empty($A_seller_shinsa["arr_koukai"])): ?>
