	...
	$(function() {
        ...
        $('.complete-item').on('click', function(){
            ...
            $('#submit_btn').click(function(){
				...
				method: 'POST',
				url: "<?php echo $_SERVER['PHP_SELF']?>",
				data: {'button_type': 'complete-item','f_serial':f_serial}
			    })
                request.done(() =>{
                alert("商品を承認しました！");
                location.reload();
...
<div class="nav nav-tabs" id="nav-tab" role="tablist">
	...
	<button class="nav-link active" id="nav-resign-wait-tab" data-bs-toggle="tab" data-bs-target="#nav-resign-wait" type="button" role="tab" aria-controls="nav-resign-wait" aria-selected="false">
		承認待ちを表示する
	</button>
	<button class="nav-link" id="nav-check-tab" data-bs-toggle="tab" data-bs-target="#nav-check" type="button" role="tab" aria-controls="nav-check" aria-selected="false">
		確認商品を表示する
	</button>
...
<div class="tab-content" id="nav-tabContent">
	...
	<div class="tab-pane fade " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
		<form method="post" id="f_base" name="f_base" action="<?php echo $_SERVER['PHP_SELF']; ?>" target="_self">
			<table class="table table-hover table-bordered top" id="shinsei_tbl">
				<thead  class="align-middle text-center top">
					<tr>
						...
						<th width="13%">会社名</th>
						<th>商品名</th>
						<th width="13%">カテゴリー</th>
						<th width="13%">単価/単価単位</th>
						<th width="10%">受注最小ロット</th>
						<th width="10%">受注最小ロットの合計金</th>
					</tr>
				</thead>
				<tbody>
			...
			<?php if(empty($A_item["all"])){
				echo ("<div class='text-center'>".$empty_item."</div>");
			} ?>
		</form>
	</div>
	<!-- 承認待ち -->
	<div class="tab-pane fade show active" id="nav-resign-wait" role="tabpanel" aria-labelledby="nav-resign-wait-tab">
		<form method="post" id="f_base" name="f_base" action="<?php echo $_SERVER['PHP_SELF']; ?>" target="_self">
			<table class="table table-hover table-bordered top" id="wait_tbl">
				...
				<tr>
					...
					<td>
						<div class="btn-group">
							<button type="button" class="btn btn-danger delete-item" id="delete-item" data-toggle="modal" data-target="#exampleModalCenter" data-name="<?php echo ($v["m_item"]); ?>" data-serial="<?php echo($v["ai_serial"]) ?>">却下</button>
							<!-- <input class="btn btn-primary complete-item" data-toggle="modal" data-target="#exampleModalCenter" type="button" data-serial="<?php echo($v["ai_serial"]) ?>" data-name="<?php echo ($v["m_item"]); ?>" value="承認"> -->
						</div>
					</td>
					<?php endif ?>
				</tr>
